...
export class StatsArea extends Container {
    ...
    constructor() {
        ...
        this.addCharacterStats([this.playerHp, this.playerAtk, this.playerDef, this.playerCrit, this.playerAgi]);
        this.addCharacterStats([this.enemyHp, this.enemyAtk, this.enemyDef, this.enemyCrit, this.enemyAgi]);
    ...
    addIcon(name) {
        let icon = new Sprite(Assets.get(name));
        icon.anchor = 0.5;
        icon.width = 32;
        icon.height = 32;
