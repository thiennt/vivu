...
export class Player extends Container {
  ...
  public fight() {
    ...
    const isCrit = getRandomItemByRate(critRate).value;
    const damage = isCrit ? this.stats.atk * 2 : this.stats.atk;
    const hitRate = this.baseHitRate + this.stats.agi;
