...
export class Menu extends Container {
  ...
  constructor() {
    ...
    this.inventoryButton = this.createMenuButton(
      "Inventory",
      Assets.get("inventory"),
    );
    ...
    this.collectionButton = this.createMenuButton(
      "Collection",
      Assets.get("spellbook"),
    );
    ...
    this.dungeonButton = this.createMenuButton(
      "Dungeon",
      Assets.get("dungeon"),
    );
    ...
    this.blocklastButton = this.createMenuButton(
      "Blocklast",
      Assets.get("hero"),
    ); // Using hero icon for now
