...
import { SkillEngine, SkillExecutionContext } from "../engine/SkillEngine";
...
export class Character extends Container {
  ...
  // New data-driven skill execution method
  public async executeSkill(
    ...
    const skill = skillEngine.getSkill(skillId);
    ...
    await skillEngine.executeSkill(context);
  }
}
