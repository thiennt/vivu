...
export class Enemy extends Container {
    ...
    public initAnimations() {
        ...
        this.animations.run = [textures.demon_3, textures.demon_4, textures.demon_5];
        this.animations.fight = [textures.demon_6, textures.demon_7, textures.demon_13];
        this.animations.crit = [
            textures.demon_6, textures.demon_7, textures.demon_13,
            textures.demon_9, textures.demon_10, textures.demon_12
        ];
    }
